/*
  string_tension_transverse_wave.pde
...
final int DISPLAY_SPEED = 20;  // the larger, the higher quicker.
final boolean DISPLAY_PHASE_VELOCITY_MARKS = true;
//-------------------</input parameters>--------------------
...
void boundaryCondition( float[] x, float y[] ) 
{
...
void drawPhaseVelocityTickMarks() {
  float string_phase_velocity = sqrt(STRING_TENSION_FORCE/STRING_MASS_DENSITY);
